...
public class ArtilleryCrateItem extends CustomItem {
    ...
    public Runnable onBlockPlace(BlockPlaceEvent e) {
        return () -> {
            ...
            ArtilleryCore artilleryCore = new ArtilleryCore(artilleryType, groupId, loc);
            try {
                ArtilleryManager artilleryManager = Arsenal.getInstance().getArtilleryManager();
                artilleryManager.putArtillery(artilleryType.instantiateNewArtillery(artilleryCore, direction, artilleryType.getMaxHealth()));
