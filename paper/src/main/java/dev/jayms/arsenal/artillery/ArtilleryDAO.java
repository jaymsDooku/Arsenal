        ...
        try (Connection insertConn = db.getConnection();
            ...
            try (ResultSet rs = selectArtillery.executeQuery()) {
                while (rs.next()) {
                    ...
                    ArtilleryCore core = new ArtilleryCore(type, groupID, loc);
                    ...
                    Artillery artillery = type.instantiateExistingArtillery(core, directionBf, structureInstance, creationTime, health);
                    ArtilleryManager artilleryManager = Arsenal.getInstance().getArtilleryManager();
                    artilleryManager.trackArtillery(artillery);
